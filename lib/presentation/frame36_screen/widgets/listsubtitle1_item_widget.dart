...
class Listsubtitle1ItemWidget extends StatelessWidget {
  Listsubtitle1ItemWidget(this.listsubtitle1ItemModelObj);

  Listsubtitle1ItemModel listsubtitle1ItemModelObj;

  var controller = Get.find<Frame36Controller>();
