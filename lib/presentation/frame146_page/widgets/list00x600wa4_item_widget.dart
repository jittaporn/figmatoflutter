...
class List00x600wa4ItemWidget extends StatelessWidget {
  List00x600wa4ItemWidget(this.list00x600wa4ItemModelObj);

  List00x600wa4ItemModel list00x600wa4ItemModelObj;

  var controller = Get.find<Frame146Controller>();
