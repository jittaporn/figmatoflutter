...
class Listframe1ItemWidget extends StatelessWidget {
  Listframe1ItemWidget(this.listframe1ItemModelObj);

  Listframe1ItemModel listframe1ItemModelObj;

  var controller = Get.find<Frame35Controller>();
