...
class List200x600wa2ItemWidget extends StatelessWidget {
  List200x600wa2ItemWidget(this.list200x600wa2ItemModelObj);

  List200x600wa2ItemModel list200x600wa2ItemModelObj;

  var controller = Get.find<Frame112Controller>();
