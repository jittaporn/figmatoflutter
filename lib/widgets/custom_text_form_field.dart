...
class CustomTextFormField extends StatelessWidget {
  ...
  _setFontStyle() {
    switch (fontStyle) {
      case TextFormFieldFontStyle.DBHelvethaicaMonX55Regular18:
        return TextStyle(
      ...
      case TextFormFieldFontStyle.DBHelvethaicaMonX55Regular22:
        return TextStyle(
  ...
  _setBorderStyle() {
    switch (variant) {
      case TextFormFieldVariant.OutlineBlack90014:
        return OutlineInputBorder(
          borderRadius: _setOutlineBorderRadius(),
          borderSide: BorderSide.none,
        );
      case TextFormFieldVariant.OutlineBlack90028:
        return OutlineInputBorder(
          borderRadius: _setOutlineBorderRadius(),
          borderSide: BorderSide.none,
        );
